...
public class CreatingCollections {
    ...
    private static void creatingLists() {
        ...
        System.out.println("---> a list the old-fashioned way");
        ...
        final List<String> friends2 = Arrays.asList("Raphael", "Olivia");
    ...
    public static void creatingMaps() {
        ...
        Map<String, Integer> ageOfFriends = Map.of("Raphael", 30, "Olivfia", 25, "Thibaut", 26);
        System.out.println(ageOfFriends);

        System.out.println("--> Creating a Map with Map.ofEntries()");
        final Map<String, Integer> ageOfFriend2 = Map.ofEntries(
                Map.entry("Raphael", 30),
                Map.entry("Olivia", 25),
                Map.entry("Thibaut", 26)
        );
        System.out.println(ageOfFriend2);
    }
}
